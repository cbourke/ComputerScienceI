...
\begin{enumerate}
  ...
  \item Write a function that given an integer array and an integer 
  $x$ determines if the array $x$ determines if the array contains $x$ within the range of the two provided indices $ i and j $ (including both indices).  It should return true if it does, false otherwise.
