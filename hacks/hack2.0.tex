...
Your program will \emph{prompt} the user to enter the latitude then longitude 
of the first location, the the latitude and longitude of the second location
(order matters).  Your output should look something like the following.  
