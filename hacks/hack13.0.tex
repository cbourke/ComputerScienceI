...
\begin{itemize}
  \item To help you troubleshoot, you should print out all the strcutres
  ...
  \item Search for an airport located in Canada (country code ``CN'') and print it out
  if it exists.  If no such airport exists, print out an appropriate message.
