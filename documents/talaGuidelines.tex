...
\begin{itemize}
  ...
  \item Rename your profile name to what you use with students and include a tag indicating your are and LA for which course (the zoom may be shared with multiple courses.  For example, \mintinline{text}{(LA - 155E)} or \mintinline{text}{(LA - 194)}.
